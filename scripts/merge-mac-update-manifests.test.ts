...
describe("merge-mac-update-manifests", () => {
  it("merges arm64 and x64 macOS update manifests into one multi-arch manifest", () => {
    const arm64 = parseMacUpdateManifest(
      `version: 0.0.4
files:
  - url: Rowl-macOS-0.0.4-arm64.zip
    sha512: arm64zip
    size: 125621344
  - url: Rowl-macOS-0.0.4-arm64.dmg
    sha512: arm64dmg
    size: 131754935
path: Rowl-macOS-0.0.4-arm64.zip
sha512: arm64zip
...
`,
    ...
    const x64 = parseMacUpdateManifest(
      `version: 0.0.4
files:
  - url: Rowl-macOS-0.0.4-x64.zip
    sha512: x64zip
    size: 132000112
  - url: Rowl-macOS-0.0.4-x64.dmg
    sha512: x64dmg
    size: 138148807
path: Rowl-macOS-0.0.4-x64.zip
sha512: x64zip
...
`,
    ...
    assert.deepStrictEqual(
      ...
      [
        "Rowl-macOS-0.0.4-arm64.zip",
        "Rowl-macOS-0.0.4-arm64.dmg",
        "Rowl-macOS-0.0.4-x64.zip",
        "Rowl-macOS-0.0.4-x64.dmg",
      ],
    );
